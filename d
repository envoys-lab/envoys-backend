describe('PlaylistService', () => {
  ...
  describe('updating a playlist', () => {
    it('calls the repository with correct paramaters', async () => {
      ...
      const playlistRepositoryCreateSpy = jest.spyOn(playlistRepository, 'create').mockReturnValue(newPlaylistData)
  ...
  describe('removing a playlist', () => {
    it('calls the repository with correct paramaters', async () => {
      ...
      const playlistRepositoryRemoveSpy = jest.spyOn(playlistRepository, 'remove').mockResolvedValue(null)
      ...
      expect(playlistRepositoryRemoveSpy).toHaveBeenCalledWith([existingPlaylist])
  ...
  describe('finding a playlist', () => {
    it('throws an error when a playlist doesnt exist', async () => {
      ...
      const playlistRepositoryFindOneSpy = jest.spyOn(playlistRepository, 'findOne').mockResolvedValue(null)
    ...
    it('returns the found playlist', async () => {
      ...
      const playlistRepositoryFindOneSpy = jest.spyOn(playlistRepository, 'findOne').mockResolvedValue(existingPlaylist)
